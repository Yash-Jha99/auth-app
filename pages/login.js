...
const Login = () => {
    ...
    return (<>
        ...
        <div className="flex justify-center items-center bg-cover bg-slate-100 dark:bg-black dark:text-white h-screen p-2" >
            <div className="w-full max-w-md min-w-max ">
                <div className="bg-white dark:bg-gray-800 shadow-xl rounded-lg px-8 py-8 ">
                    ...
                    <div className="mb-3">
                        <label className={`${error.email ? "text-red-500 dark:text-red-500" : "text-gray-700 dark:text-white"} block  text-md font-semibold mb-1`} htmlFor="email">
                            Email*
                        </label>
                        <input value={email} name="email" className={` appearance-none border rounded w-full py-2 px-3 text-lg text-gray-700 dark:text-white  mb-1 leading-tight focus:outline-blue-500 dark:focus:outline-blue-500 ${error.email && "border-red-500"}`} id="email" type="email" onChange={handleChange} />
                    </div>
                    <div className="mb-6">
                        <label className={`${error.password ? "text-red-500 dark:text-red-500" : "text-gray-700 dark:text-white"} block  text-md font-semibold mb-1`} htmlFor="email">
                            Password*
                        </label>
                        <input value={password} name="password" className={` appearance-none border rounded w-full py-2 px-3 text-lg text-gray-700 dark:text-white mb-1 leading-tight focus:outline-blue-500 dark:focus:outline-blue-500 ${error.password && "border-red-500"}`} id="password" type="password" onChange={handleChange} />
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div>
                            <div className='flex items-center'>
                                <p className='text-sm text-gray-700 dark:text-white'>{signup ? "Already a user" : "Don't have an account"}</p>
                            ...
                            <div className='flex items-center'>
                                <p className='text-sm text-gray-700 dark:text-white'>Forgot password?</p>
